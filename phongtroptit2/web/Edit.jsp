                    ...
                    <div class="modal-content">
                        <form action="edit" method="post">
                            ...
                            <div class="modal-body">					
                                ...
                                <div class="form-group">
                                    <label>LinkFB</label>
                                    <input value="${detail.fb}" name="fb" type="text" class="form-control" required>
                                </div>
                                <div class="form-group">
                                    <label>Email</label>
                                    <input value="${detail.gmail}" name="gmail" type="text" class="form-control" required>
                                </div>
                               <div class="form-group">
                                    <label>Vị Trí</label>
                                    <textarea name="ggmap" class="form-control" required>${detail.ggmap}</textarea>
                                </div>
